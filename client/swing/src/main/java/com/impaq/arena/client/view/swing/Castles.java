...
import com.impaq.arena.client.view.swing.sprite.CastleSprite;
import com.impaq.arena.client.view.swing.sprite.CastleSprite.Side;
...
class Castles extends Component {
    ...
    private final int maxCastle;

    public Castles(Point position, int maxCastle) {
        super(position);
        this.maxCastle = maxCastle;
