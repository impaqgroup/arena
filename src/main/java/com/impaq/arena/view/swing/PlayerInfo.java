...
import com.impaq.arena.view.swing.common.animation.Pause;
...
public class PlayerInfo extends Component {
    ...
    private static class Arrow extends Component {
        ...
        private Animation show() {
            return Chain.of(new FadeIn(this, FADE_IN_DURATION), new Pause(DISPAY_DURATION), new FadeOut(this, FADE_OUT_DURATION));
        }
    }
